...
# --- Configuration ---
WORD_FILE_PATH = "my_document.docx"
CHROMA_PERSIST_DIR = "chroma_db"
EMBEDDING_MODEL_NAME = "sentence-transformers/all-MiniLM-L6-v2" # Good balance
GROQ_MODEL_NAME = "llama3-70b-8192" # Or another Groq-supported model
...
def main():
    ...
    if not os.path.exists(WORD_FILE_PATH):
        print(f"Error: Word document not found at {WORD_FILE_PATH}")
        print("Please create a 'my_document.docx' file with some content.")
        return

    print(f"Extracting text from {WORD_FILE_PATH}...")
    document_content = extract_text_from_docx(WORD_FILE_PATH)
    ...
    try:
        ...
        groq_llm = ChatGroq(model_name=GROQ_MODEL_NAME)
        # Basic test
